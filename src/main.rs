...
use hoohash_miner::PluginManager;
use log::{error, info};
...
async fn main() -> Result<(), Error> {
    ...
    let (app, mut plugin_manager): (App, PluginManager) = hoohash_miner::load_plugins(Opt::into_app(), &plugins)?;
    ...
    info!("=================================================================================");
    info!("                 hoohash-miner GPU {}", env!("CARGO_PKG_VERSION"));
